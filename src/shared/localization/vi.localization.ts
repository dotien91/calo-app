...
export default {
  ...
  evaluation: {
    day: "Ngày",
    onTime: "Đi học đúng giờ",
    attitude: "Thái độ học tập",
    lessonParticipation: "Tham gia bài học",
    improvementPoints: "Điểm cần cải thiện",
    doesHomework: "Làm bài tập về nhà",
    takeNotes: "Chép bài trên lớp",
    send: "Gửi đánh giá",
    listEvalua: "Danh sách đánh giá",
    listStudents: "Danh sách học viên",
    success: "Đã gửi đánh giá",
    updated: "Đã cập nhật đánh giá",
    evaluation: "Đánh giá học viên",
    desc: "Đánh giá học viên qua từng buổi học để nâng cao hiệu quả học tập",
    onTimeVal1: "Vào đúng giờ",
    onTimeVal2: "Đi muộn",
    onTimeVal3: "Nghỉ có phép",
    onTimeVal4: "Nghỉ không phép",
    attitudePos: "Tốt",
    attitudeNeg: "Chưa tốt",
    takeNoteVal1: "Có",
    takeNoteVal2: "Không",
    doesHomeworkVal1: "Đã làm",
    doesHomeworkVal2: "Chưa làm",
  },
  ...
  noCertificates: "Chuyên gia chưa cập nhật chứng chỉ!",
  today: "Hôm nay",
  yesterday: "Hôm qua",
  tomorrow: "ngày mai",
  from: "Từ",
  ...
  post: {
    ...
    emptyPostDes:
      "Khi một người bạn hoặc chuyên gia đăng một bài viết, nó sẽ xuất hiện ở đây và sau đó bạn có thể thích, chia sẻ và bình luận về bài đăng đó.",
  ...
  course: {
    ...
    viewResultTutor: (text: string) =>
      text != 0 ? "Xem " + text + " chuyên gia" : "Không tìm thấy kết quả",
  ...
  profileTeacher: {
    revenua: "Doanh thu",
    withdraw: "Rút tiền",
    setUpAccount: "Cài đặt STK",
    myCourse: "Khóa học của tôi",
    schedule: "Lịch dạy học",
    discount: "Mã giảm giá",
    chat: "Chat với học viên",
    setTeaching: "Cài đặt giờ dạy",
    manageClass: "Quản lý lớp học",
    customProfile: "Tùy chỉnh hồ sơ",
    manageCerti: "Quản lý chứng chỉ",
    myClub: "Câu lạc bộ của tôi",
    myPodcast: "Podcast của tôi",
    guide: "Hướng dẫn sử dụng",
    Security: "Bảo mật và chính sách",
    finance: "TÀI CHÍNH",
    course: "KHÓA HỌC",
  ...
  podcast: {
    ...
    createPodcastFaild: "Tải lên podcast không thành công",
    public: "Công khai",
    member: "Hội viên",
    updating: "Sách nói đang được cập nhật, thử lại sau",
    listPodcast: "Danh sách podcast",
  ...
  audio: {
    ...
    business: "Kinh doanh",
    finance: "Tài chính",
    emptyAudio: "Không có podcast nào",
  ...
  club: {
    memberToAdmin: "Cấp quyền admin",
    adminToMember: "Thu hồi quyền admin",
    ...
    admin: "Quản trị viên",
    leader: "Người tạo",
    infoClubError: "Không lấy được thông tin câu lạc bộ, vui lòng thử lại",
    joinClubFalid: "Tham gia câu lạc bộ không thành công, vui lòng thử lại",
    ...
    attended: "Tham gia",
    attended2: "Đã tham gia",
    ago: "trước",
    purchaseJoin: "Mua để tham gia câu lạc bộ",
    about: "Thông tin",
    seeMore: "Xem thêm",
    history: "Lịch sử",
    title: "Chủ tịch câu lạc bộ và Quản trị viên",
    group: "Hoạt động câu lạc bộ",
    newPosts: "bài viết mới ngày hôm nay",
    members: "thành viên",
    joinGruop: "Tham gia câu lạc bộ",
    inCome: "đã tham gia tuần trước",
    created: "Đã tạo",
    tab1: "Nổi bật",
    tab2: "Của bạn",
    tab3: "Đã tham gia",
    des1: "Câu lạc bộ được tạo từ",
    des2: ". Tên được thay đổi lần cuối vào",
    des3: "và",
    des4: "thành viên khác là admin.",
    createAt: (create: string, update: string) =>
      create != update
        ? `Câu lạc bộ được tạo vào ${create}. Tên thay đổi lần cuối vào ${update}.`
        : `Câu lạc bộ được tạo vào ${create}.`,
  ...
  close: "Đóng",
  setup: {
    title1: "Chọn 1 hoặc nhiều chủ đề bạn quan tâm.",
    life: "Cuộc sống",
    business: "Kinh doanh",
    finance: "Tài chính",
    orientation: "Định hướng",
    ...
    timeMana: "Quản lý thời gian",
    stressMana: "Quản lý căng thẳng",
    healthAndWell: "Sức khỏe & Sự thịnh vượng",
    nutri: "Dinh dưỡng & Chế độ ăn",
    fitness: "Thể dục & Tập luyện",
    mental: "Sức khỏe tâm thần",
    sleep: "Cải thiện giấc ngủ",
    businessCare: "Kinh doanh & Sự nghiệp",
    businessCoa: "Huấn luyện kinh doanh",
    careerDeve: "Phát triển sự nghiệp",
    entre: "Khởi nghiệp",
  ...
  manageCertificate: {
    ...
    des: "Chứng nhận của bạn sẽ được hiển thị trên trang chủ",
    addCertificate: "Thêm chứng chỉ",
    addCertificateSuccess: "Thêm chứng chỉ thành công",
    deleteCertificate: "Xóa chứng chỉ",
    confirmDeleteCertificate: "Bạn có muốn xóa chứng chỉ này!",
    deleteCertificateSuccess: "Xóa chứng chỉ thành công",
    editCertificate: "Chỉnh sửa chứng chỉ",
    editCertificateSuccess: "Chỉnh sửa chứng chỉ thành công",
    certificate: "Chứng chỉ",
    desCertificate: "Mô tả chứng chỉ",
    chooseImageCertificate: "Chọn ảnh chứng chỉ",
    chooseImageCertificateError: "Vui lòng chọn ảnh chứng chỉ",
    chooseCertificate: "Chọn chứng chỉ",
    chooseCertificateSuccess: "Chọn chứng chỉ thành công",
  ...
  description: "Mô tả",
  premiumAccount: {
    freeTrial: "Dùng thử 3 ngày miễn phí",
    day: "Ngày",
    month: "Tháng",
    months: "Tháng",
    year: "Năm",
    ...
    unlimitedChangeLocation: "Thay đổi vị trí không giới hạn",
    ...
    startDate: "Ngày mua: ",
    endDate: "Hết hạn: ",
    unlimitedCall: "Gọi điện không giới hạn",
    endsIn: "Kết thúc trong",
    only: "Còn lại",
    promotionLeft: "suất giảm giá",
    rightNow: "trong hôm nay!",
    days: "Ngày",
    weeks: "Tuần",
    week: "Tuần",
    listServiceEmpty: "Danh sách các dịch vụ trống",
    free: "Miễn phí",
    trial: "dùng thử",
    then: "sau đó",
    from: "từ",
