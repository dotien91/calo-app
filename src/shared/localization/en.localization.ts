...
export default {
  ...
  "subscription": {
    ...
    "confirmDeleteSubscription": "Do you want to delete this subscription service?",
  ...
  premiumAccount: {
    ...
    whiteGPro: "Premium",
    proDes: "Upgrade to Premium for view who like you, enable travel mode and unlimited reply message, call!",
    getPro: "Get Premium",
    ...
    advanceFilter: "Advance filter User (Role, Distance, Body type, Online time)",
