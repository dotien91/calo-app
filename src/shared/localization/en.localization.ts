...
export default {
  ...
  evaluation: {
    day: "Day",
    onTime: "Attend on time",
    attitude: "Learning attitude",
    lessonParticipation: "Lesson participation",
    improvementPoints: "Improvement points",
    doesHomework: "Does homework",
    takeNotes: "Takes notes in class",
    send: "Send evaluation",
    listEvalua: "Evaluation List",
    listStudents: "Student List",
    success: "Evaluation Sent Successfully",
    updated: "Evaluation Updated Successfully",
    evaluation: "Student Evaluation",
    desc: "Evaluate students after each lesson to improve learning outcomes",
    onTimeVal1: "On time",
    onTimeVal2: "Late",
    onTimeVal3: "Leave with permission",
    onTimeVal4: "Absent without permission",
    attitudePos: "Good",
    attitudeNeg: "Not good",
    takeNoteVal1: "Yes",
    takeNoteVal2: "No",
    doesHomeworkVal1: "Completed",
    doesHomeworkVal2: "Not completed",
  },
  ...
  subscription: {
    ...
    des: "Your subscription service will be displayed on the homepage",
    addSubscription: "Add Subscription Service",
    addSubscriptionSuccess: "Successfully added subscription service",
    deleteSubscription: "Delete Subscription Service",
    confirmDeleteSubscription:
      "Do you want to delete this subscription service?",
    deleteSubscriptionSuccess: "Successfully deleted subscription service",
    editSubscription: "Edit Subscription Service",
    editSubscriptionSuccess: "Successfully edited subscription service",
    description: "Earn extra income from uploaded podcast content",
  },
  label: "Title",
  description: "Description",
  premiumAccount: {
    ...
    des3: "Value-Added Service Term of Ikes Privacy Policy Term of Automatic Subscription Renewal",
    error: "Error",
    getServiceFail: "Get Service Failed",
    whiteGPro: "Premium",
    proDes:
      "Upgrade to Premium for view who like you, enable travel mode and unlimited reply message, call!",
    getPro: "Get Premium",
    unlimitedViewUser: "Unlimited view user in Homepage",
    fullVisitorList: "Full visitor list",
    unlimitedChangeLocation: "Unlimited change location",
    call30minutes: "30 minutes free call per Chat room",
    fullFollowList: "Full follow list",
    unlimitedReplyMessage: "Unlimited reply message",
    advanceFilter:
      "Advance filter User (Role, Distance, Body type, Online time)",
    fullFilter: "Full filter User",
    spotLight: "Spotlight in Chat list, Homepage...",
    proFunction: ":PRO FUNCTION",
    upgrade: "Upgrade",
    startDate: "Start date: ",
    endDate: "End date: ",
    unlimitedCall: "Unlimited call",
    endsIn: "Ends in",
    only: "Only",
    promotionLeft: "promotions left - Get",
    rightNow: "Off right now!",
    days: "Days",
    weeks: "Weeks",
    week: "Week",
    listServiceEmpty: "List service empty",
    free: "Free",
    trial: "trial",
    then: "then",
    from: "from",
