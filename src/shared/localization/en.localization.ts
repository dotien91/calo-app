...
export default {
  ...
  club: {
    ...
    admin: "Admin",
    leader: "Leader",
    infoClubError: "Failed to retrieve group information, please try again",
    joinClubFalid: "Failed to join the group, please try again",
    clubName: "Club name",
    ...
    attended: "Attended",
    ago: "ago",
    purchaseJoin: "Purchase to join group",
    about: "About",
    seeMore: "See more",
    history: "History",
    ...
    members: "members",
    joinGruop: "Join group",
    inCome: "in the last week",
    created: "Created",
    tab1: "Features",
    tab2: "Managed clubs",
    tab3: "Joined clubs",
    des1: "Group created on",
