...
//cp android
appcenter codepush release-react -a dev-ikigroup/IELTS-Hunter-1 -d Development -t 1.0.0
//cp ios
appcenter codepush release-react -a dev-ikigroup/IELTS-Hunter -d Development -t 1.0.0
