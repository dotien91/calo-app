...
//cp android
appcenter codepush release-react -a dev-ikigroup/IELTS-Hunter-1 -d Development -t 0.1.99
//cp ios
appcenter codepush release-react -a dev-ikigroup/IELTS-Hunter -d Development -t 0.1.99
